...
//   Recordables map
// ---------------------------------------------------------------------------
nest::RecordablesMap<eglif_gr_nestml> eglif_gr_nestml::recordablesMap_;

void
nest::register_eglif_gr_nestml( const std::string& name )
{
  register_node_model< eglif_gr_nestml >( name );
}
...
template <> 
void 
RecordablesMap<eglif_gr_nestml>::create()
  {
    // add state variables to recordables map
   insert_(eglif_gr_nestml_names::_V_m, &eglif_gr_nestml::get_V_m);
   insert_(eglif_gr_nestml_names::_I_adap, &eglif_gr_nestml::get_I_adap);
   insert_(eglif_gr_nestml_names::_I_dep, &eglif_gr_nestml::get_I_dep);
   insert_(eglif_gr_nestml_names::_lambda, &eglif_gr_nestml::get_lambda);
   insert_(eglif_gr_nestml_names::_tick, &eglif_gr_nestml::get_tick);
   insert_(eglif_gr_nestml_names::_received_offset, &eglif_gr_nestml::get_received_offset);
   insert_(eglif_gr_nestml_names::_cf_buffer, &eglif_gr_nestml::get_cf_buffer);
   insert_(eglif_gr_nestml_names::_g1__X__rec1, &eglif_gr_nestml::get_g1__X__rec1);
   insert_(eglif_gr_nestml_names::_g1__X__rec1__d, &eglif_gr_nestml::get_g1__X__rec1__d);
   insert_(eglif_gr_nestml_names::_g4__X__rec4, &eglif_gr_nestml::get_g4__X__rec4);
   insert_(eglif_gr_nestml_names::_g4__X__rec4__d, &eglif_gr_nestml::get_g4__X__rec4__d);
   insert_(eglif_gr_nestml_names::_g2__X__rec2, &eglif_gr_nestml::get_g2__X__rec2);
   insert_(eglif_gr_nestml_names::_g2__X__rec2__d, &eglif_gr_nestml::get_g2__X__rec2__d);
   insert_(eglif_gr_nestml_names::_g3__X__rec3, &eglif_gr_nestml::get_g3__X__rec3);
   insert_(eglif_gr_nestml_names::_g3__X__rec3__d, &eglif_gr_nestml::get_g3__X__rec3__d);
    // add recordable inline expressions to recordables map
	insert_(eglif_gr_nestml_names::_I_syn, &eglif_gr_nestml::get_I_syn);
	insert_(eglif_gr_nestml_names::_I_tot, &eglif_gr_nestml::get_I_tot);

    // Add vector variables  
  }
}
std::vector< std::tuple< int, int > > eglif_gr_nestml::rport_to_nestml_buffer_idx =
{
  { eglif_gr_nestml::REC1, eglif_gr_nestml::PORT_NOT_AVAILABLE },
  { eglif_gr_nestml::REC2, eglif_gr_nestml::PORT_NOT_AVAILABLE },
  { eglif_gr_nestml::REC3, eglif_gr_nestml::PORT_NOT_AVAILABLE },
  { eglif_gr_nestml::REC4, eglif_gr_nestml::PORT_NOT_AVAILABLE },
  { eglif_gr_nestml::CF_SPIKES, eglif_gr_nestml::PORT_NOT_AVAILABLE },
};

// ---------------------------------------------------------------------------
//   Default constructors defining default parameters and state
//   Note: the implementation is empty. The initialization is of variables
//   is a part of eglif_pc_nestml's constructor.
// ---------------------------------------------------------------------------

eglif_gr_nestml::Parameters_::Parameters_()
{
}

eglif_gr_nestml::State_::State_()
{
}
...
eglif_gr_nestml::Buffers_::Buffers_(eglif_gr_nestml &n):
  logger_(n)
...
eglif_gr_nestml::Buffers_::Buffers_(const Buffers_ &, eglif_gr_nestml &n):
  logger_(n)
  , spike_inputs_( std::vector< nest::RingBuffer >( NUM_SPIKE_RECEPTORS ) )
  , spike_inputs_grid_sum_( std::vector< double >( NUM_SPIKE_RECEPTORS ) )
  , spike_input_received_( std::vector< nest::RingBuffer >( NUM_SPIKE_RECEPTORS ) )
...
eglif_gr_nestml::eglif_gr_nestml():ExtendedPostHistoryArchivingNode(), P_(), S_(), B_(*this)
{
...
eglif_gr_nestml::eglif_gr_nestml(const eglif_gr_nestml& __n):
  ExtendedPostHistoryArchivingNode(), P_(__n.P_), S_(__n.S_), B_(__n.B_, *this)
{
  ...
  S_.tick = __n.S_.tick;
  S_.received_offset = __n.S_.received_offset;
...
eglif_gr_nestml::~eglif_gr_nestml()
{
...
// ---------------------------------------------------------------------------
void eglif_gr_nestml::calibrate_time( const nest::TimeConverter& tc )
{
  LOG( nest::M_WARNING,
    "eglif_pc_nestml",
...
void eglif_gr_nestml::init_state_internal_()
{
#ifdef DEBUG
  std::cout << "eglif_pc_nestml::init_state_internal_()" << std::endl;
#endif
...
void eglif_gr_nestml::init_buffers_()
{
#ifdef DEBUG
  std::cout << "eglif_pc_nestml::init_buffers_()" << std::endl;
#endif
  // spike input buffers
  ...
  // B_.__sys.function = eglif_pc_nestml_dynamics; // will be set just prior to the call to gsl_odeiv_evolve_apply()
...
void eglif_gr_nestml::recompute_internal_variables(bool exclude_timestep)
{
  const double __resolution = nest::Time::get_resolution().get_ms();  // do not remove, this is necessary for the resolution() function
...
void eglif_gr_nestml::pre_run_hook()
{
  B_.logger_.init();
...
extern "C" inline int eglif_gr_nestml_dynamics(double __time, const double ode_state[], double f[], void* pnode)
{
  typedef eglif_gr_nestml::State_ State_;
  // get access to node so we can almost work as in a member function
  assert( pnode );
  const eglif_gr_nestml& node = *( reinterpret_cast< eglif_gr_nestml* >( pnode ) );
...
void eglif_gr_nestml::update(nest::Time const & origin,const long from, const long to)
{
  const double __resolution = nest::Time::get_resolution().get_ms();  // do not remove, this is necessary for the resolution() function
...
double rec_5 = get_spike_input_received_()[1].get_value(lag);
    ...
    {  
        ...
        double __t = 0;
        B_.__sys.function = eglif_gr_nestml_dynamics;
...
void eglif_gr_nestml::handle(nest::DataLoggingRequest& e)
{
  B_.logger_.handle(e);
}


void eglif_gr_nestml::handle(nest::SpikeEvent &e)
{
  ...
  if (e.get_offset() >0.0)
  {
    ...
    //std::cout << "Gr: Got a complex spike with offset " << e.get_offset() << "\n";
  ...
  else
  {
    ...
    if ( nestml_buffer_idx == eglif_gr_nestml::PORT_NOT_AVAILABLE )
    {
      nestml_buffer_idx = std::get<0>(rport_to_nestml_buffer_idx[e.get_rport()]);
    }
    weight = -weight;
...
void eglif_gr_nestml::handle(nest::CurrentEvent& e)
{
  assert(e.get_delay_steps() > 0);
