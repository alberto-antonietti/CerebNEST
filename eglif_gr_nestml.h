...
**/
#ifndef EGLIF_GR_NESTML
#define EGLIF_GR_NESTML
...
namespace nest
{
   void register_eglif_gr_nestml( const std::string& name );
}
namespace eglif_gr_nestml_names
{
    const Name _V_m( "V_m" );
    ...
    const Name _received_offset("received_offset");
...
extern "C" inline int eglif_gr_nestml_dynamics( double, const double ode_state[], double f[], void* pnode );
...
class eglif_gr_nestml : public nest::ExtendedPostHistoryArchivingNode
{
public:
  /**
  ...
  **/
  eglif_gr_nestml(const eglif_gr_nestml &);

  /**
   * Destructor.
  **/
  ~eglif_gr_nestml() override;
  ...
  **/
  ...
  inline double get_received_offset() const
  {
    return S_.received_offset;
  }

  inline void set_received_offset(const double __v)
  {
    S_.received_offset = __v;
  }
...
static std::vector< std::tuple< int, int > > rport_to_nestml_buffer_idx;
  ...
  **/
  ...
  friend class nest::RecordablesMap<eglif_gr_nestml>;
  friend class nest::UniversalDataLogger<eglif_gr_nestml>;
...
double received_offset;
  ...
  **/
  struct Buffers_
  {
    Buffers_(eglif_gr_nestml &);
    Buffers_(const Buffers_ &, eglif_gr_nestml &);

    /**
     * Logger for all analog data
    **/
    nest::UniversalDataLogger<eglif_gr_nestml> logger_;
...
inline nest::RingBuffer& get_I_stim() {
  ...
  static nest::RecordablesMap<eglif_gr_nestml> recordablesMap_;
  friend int eglif_gr_nestml_dynamics( double, const double ode_state[], double f[], void* pnode );
...
}; /* neuron eglif_pc_nestml */

inline nest_port_t eglif_gr_nestml::send_test_event(nest::Node& target, nest_rport_t receptor_type, nest::synindex, bool)
{
...
inline nest_port_t eglif_gr_nestml::handles_test_event(nest::SpikeEvent&, nest_port_t receptor_type)
{
...
inline nest_port_t eglif_gr_nestml::handles_test_event(nest::CurrentEvent&, nest_port_t receptor_type)
{
  // You should usually not change the code in this function.
...
inline nest_port_t eglif_gr_nestml::handles_test_event(nest::DataLoggingRequest& dlr, nest_port_t receptor_type)
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline void eglif_gr_nestml::get_status(DictionaryDatum &__d) const
{
  // parameters
  def< double >(__d, eglif_gr_nestml_names::_C_m, get_C_m());
  def< double >(__d, eglif_gr_nestml_names::_tau_m, get_tau_m());
  def< double >(__d, eglif_gr_nestml_names::_E_L, get_E_L());
  def< double >(__d, eglif_gr_nestml_names::_t_ref, get_t_ref());
  def< double >(__d, eglif_gr_nestml_names::_V_reset, get_V_reset());
  def< double >(__d, eglif_gr_nestml_names::_V_th, get_V_th());
  def< double >(__d, eglif_gr_nestml_names::_Vmin, get_Vmin());
  def< double >(__d, eglif_gr_nestml_names::_I_e, get_I_e());
  def< double >(__d, eglif_gr_nestml_names::_Vinit, get_Vinit());
  def< double >(__d, eglif_gr_nestml_names::_lambda_0, get_lambda_0());
  def< double >(__d, eglif_gr_nestml_names::_tau_V, get_tau_V());
  def< double >(__d, eglif_gr_nestml_names::_kadap, get_kadap());
  def< double >(__d, eglif_gr_nestml_names::_k2, get_k2());
  def< double >(__d, eglif_gr_nestml_names::_k1, get_k1());
  def< double >(__d, eglif_gr_nestml_names::_A1, get_A1());
  def< double >(__d, eglif_gr_nestml_names::_A2, get_A2());
  def< double >(__d, eglif_gr_nestml_names::_E_rev1, get_E_rev1());
  def< double >(__d, eglif_gr_nestml_names::_E_rev2, get_E_rev2());
  def< double >(__d, eglif_gr_nestml_names::_E_rev3, get_E_rev3());
  def< double >(__d, eglif_gr_nestml_names::_E_rev4, get_E_rev4());
  def< double >(__d, eglif_gr_nestml_names::_tau_syn1, get_tau_syn1());
  def< double >(__d, eglif_gr_nestml_names::_tau_syn2, get_tau_syn2());
  def< double >(__d, eglif_gr_nestml_names::_tau_syn3, get_tau_syn3());
  def< double >(__d, eglif_gr_nestml_names::_tau_syn4, get_tau_syn4());
  def< double >(__d, eglif_gr_nestml_names::_offset, get_offset());

  // initial values for state variables in ODE or kernel
  def< double >(__d, eglif_gr_nestml_names::_V_m, get_V_m());
  def< double >(__d, eglif_gr_nestml_names::_I_adap, get_I_adap());
  def< double >(__d, eglif_gr_nestml_names::_I_dep, get_I_dep());
  def< long >(__d, eglif_gr_nestml_names::_r, get_r());
  def< double >(__d, eglif_gr_nestml_names::_lambda, get_lambda());
  def< double >(__d, eglif_gr_nestml_names::_cf_buffer, get_cf_buffer());
  def< double >(__d, eglif_gr_nestml_names::_tick, get_tick());
  def< double >(__d, eglif_gr_nestml_names::_received_offset, get_received_offset());
  def< double >(__d, eglif_gr_nestml_names::_g4__X__rec4, get_g4__X__rec4());
  def< double >(__d, eglif_gr_nestml_names::_g4__X__rec4__d, get_g4__X__rec4__d());
  def< double >(__d, eglif_gr_nestml_names::_g2__X__rec2, get_g2__X__rec2());
  def< double >(__d, eglif_gr_nestml_names::_g2__X__rec2__d, get_g2__X__rec2__d());
  def< double >(__d, eglif_gr_nestml_names::_g1__X__rec1, get_g1__X__rec1());
  def< double >(__d, eglif_gr_nestml_names::_g1__X__rec1__d, get_g1__X__rec1__d());
  def< double >(__d, eglif_gr_nestml_names::_g3__X__rec3, get_g3__X__rec3());
  def< double >(__d, eglif_gr_nestml_names::_g3__X__rec3__d, get_g3__X__rec3__d());
...
inline void eglif_gr_nestml::set_status(const DictionaryDatum &__d)
{
  // parameters
  double tmp_C_m = get_C_m();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_C_m, tmp_C_m, this);
  double tmp_tau_m = get_tau_m();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_tau_m, tmp_tau_m, this);
  double tmp_E_L = get_E_L();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_E_L, tmp_E_L, this);
  double tmp_t_ref = get_t_ref();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_t_ref, tmp_t_ref, this);
  double tmp_V_reset = get_V_reset();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_V_reset, tmp_V_reset, this);
  double tmp_V_th = get_V_th();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_V_th, tmp_V_th, this);
  double tmp_Vmin = get_Vmin();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_Vmin, tmp_Vmin, this);
  double tmp_I_e = get_I_e();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_I_e, tmp_I_e, this);
  double tmp_Vinit = get_Vinit();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_Vinit, tmp_Vinit, this);
  double tmp_lambda_0 = get_lambda_0();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_lambda_0, tmp_lambda_0, this);
  double tmp_tau_V = get_tau_V();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_tau_V, tmp_tau_V, this);
  double tmp_kadap = get_kadap();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_kadap, tmp_kadap, this);
  double tmp_k2 = get_k2();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_k2, tmp_k2, this);
  double tmp_k1 = get_k1();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_k1, tmp_k1, this);
  double tmp_A1 = get_A1();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_A1, tmp_A1, this);
  double tmp_A2 = get_A2();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_A2, tmp_A2, this);
  double tmp_E_rev1 = get_E_rev1();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_E_rev1, tmp_E_rev1, this);
  double tmp_E_rev2 = get_E_rev2();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_E_rev2, tmp_E_rev2, this);
  double tmp_E_rev3 = get_E_rev3();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_E_rev3, tmp_E_rev3, this);
  double tmp_E_rev4 = get_E_rev4();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_E_rev4, tmp_E_rev4, this);
  double tmp_tau_syn1 = get_tau_syn1();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_tau_syn1, tmp_tau_syn1, this);
  double tmp_tau_syn2 = get_tau_syn2();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_tau_syn2, tmp_tau_syn2, this);
  double tmp_tau_syn3 = get_tau_syn3();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_tau_syn3, tmp_tau_syn3, this);
  double tmp_tau_syn4 = get_tau_syn4();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_tau_syn4, tmp_tau_syn4, this);
  double tmp_offset = get_offset();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_offset, tmp_offset, this);
  // initial values for state variables in ODE or kernel
  double tmp_V_m = get_V_m();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_V_m, tmp_V_m, this);
  double tmp_I_adap = get_I_adap();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_I_adap, tmp_I_adap, this);
  double tmp_I_dep = get_I_dep();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_I_dep, tmp_I_dep, this);
  long tmp_r = get_r();
  nest::updateValueParam<long>(__d, eglif_gr_nestml_names::_r, tmp_r, this);
  double tmp_lambda = get_lambda();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_lambda, tmp_lambda, this);
  double tmp_cf_buffer = get_cf_buffer();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_cf_buffer, tmp_cf_buffer, this);
  double tmp_tick = get_tick();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_tick, tmp_tick, this);
  double tmp_received_offset = get_received_offset();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_received_offset, tmp_received_offset, this);
  double tmp_g4__X__rec4 = get_g4__X__rec4();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_g4__X__rec4, tmp_g4__X__rec4, this);
  double tmp_g4__X__rec4__d = get_g4__X__rec4__d();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_g4__X__rec4__d, tmp_g4__X__rec4__d, this);
  double tmp_g2__X__rec2 = get_g2__X__rec2();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_g2__X__rec2, tmp_g2__X__rec2, this);
  double tmp_g2__X__rec2__d = get_g2__X__rec2__d();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_g2__X__rec2__d, tmp_g2__X__rec2__d, this);
  double tmp_g1__X__rec1 = get_g1__X__rec1();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_g1__X__rec1, tmp_g1__X__rec1, this);
  double tmp_g1__X__rec1__d = get_g1__X__rec1__d();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_g1__X__rec1__d, tmp_g1__X__rec1__d, this);
  double tmp_g3__X__rec3 = get_g3__X__rec3();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_g3__X__rec3, tmp_g3__X__rec3, this);
  double tmp_g3__X__rec3__d = get_g3__X__rec3__d();
  nest::updateValueParam<double>(__d, eglif_gr_nestml_names::_g3__X__rec3__d, tmp_g3__X__rec3__d, this);
  ...
  set_tick(tmp_tick);
  set_received_offset(tmp_received_offset);
