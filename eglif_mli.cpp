...
//   Recordables map
// ---------------------------------------------------------------------------
nest::RecordablesMap<eglif_mli> eglif_mli::recordablesMap_;

void
nest::register_eglif_mli( const std::string& name )
{
  register_node_model< eglif_mli >( name );
}
...
template <> 
void 
RecordablesMap<eglif_mli>::create()
  {
    // add state variables to recordables map
   insert_(eglif_mli_names::_V_m, &eglif_mli::get_V_m);
   insert_(eglif_mli_names::_I_adap, &eglif_mli::get_I_adap);
   insert_(eglif_mli_names::_I_dep, &eglif_mli::get_I_dep);
   insert_(eglif_mli_names::_lambda, &eglif_mli::get_lambda);
   insert_(eglif_mli_names::_tick, &eglif_mli::get_tick);
   insert_(eglif_mli_names::_cf_buffer, &eglif_mli::get_cf_buffer);
   insert_(eglif_mli_names::_gr_buffer, &eglif_mli::get_gr_buffer);
   insert_(eglif_mli_names::_last_io, &eglif_mli::get_last_io);
   insert_(eglif_mli_names::_complex_flag, &eglif_mli::get_complex_flag);
   insert_(eglif_mli_names::_g1__X__rec1, &eglif_mli::get_g1__X__rec1);
   insert_(eglif_mli_names::_g1__X__rec1__d, &eglif_mli::get_g1__X__rec1__d);
   insert_(eglif_mli_names::_g4__X__rec4, &eglif_mli::get_g4__X__rec4);
   insert_(eglif_mli_names::_g4__X__rec4__d, &eglif_mli::get_g4__X__rec4__d);
   insert_(eglif_mli_names::_g2__X__rec2, &eglif_mli::get_g2__X__rec2);
   insert_(eglif_mli_names::_g2__X__rec2__d, &eglif_mli::get_g2__X__rec2__d);
   insert_(eglif_mli_names::_g3__X__rec3, &eglif_mli::get_g3__X__rec3);
   insert_(eglif_mli_names::_g3__X__rec3__d, &eglif_mli::get_g3__X__rec3__d);
    // add recordable inline expressions to recordables map
	insert_(eglif_mli_names::_I_syn, &eglif_mli::get_I_syn);
	insert_(eglif_mli_names::_I_tot, &eglif_mli::get_I_tot);

    // Add vector variables  
  }
}
std::vector< std::tuple< int, int > > eglif_mli::rport_to_nestml_buffer_idx =
{
  { eglif_mli::REC1, eglif_mli::PORT_NOT_AVAILABLE },
  { eglif_mli::REC2, eglif_mli::PORT_NOT_AVAILABLE },
  { eglif_mli::REC3, eglif_mli::PORT_NOT_AVAILABLE },
  { eglif_mli::REC4, eglif_mli::PORT_NOT_AVAILABLE },
};

// ---------------------------------------------------------------------------
//   Default constructors defining default parameters and state
//   Note: the implementation is empty. The initialization is of variables
//   is a part of eglif_mli's constructor.
// ---------------------------------------------------------------------------

eglif_mli::Parameters_::Parameters_()
{
}

eglif_mli::State_::State_()
{
}
...
eglif_mli::Buffers_::Buffers_(eglif_mli &n):
  logger_(n)
...
eglif_mli::Buffers_::Buffers_(const Buffers_ &, eglif_mli &n):
  logger_(n)
  , spike_inputs_( std::vector< nest::RingBuffer >( NUM_SPIKE_RECEPTORS ) )
  , spike_inputs_grid_sum_( std::vector< double >( NUM_SPIKE_RECEPTORS ) )
  , spike_input_received_( std::vector< nest::RingBuffer >( NUM_SPIKE_RECEPTORS ) )
...
eglif_mli::eglif_mli():ExtendedPostHistoryArchivingNode(), P_(), S_(), B_(*this)
{
...
eglif_mli::eglif_mli(const eglif_mli& __n):
...
// ---------------------------------------------------------------------------
void eglif_mli::calibrate_time( const nest::TimeConverter& tc )
{
  LOG( nest::M_WARNING,
    "eglif_mli",
...
void eglif_mli::init_buffers_()
{
#ifdef DEBUG
  std::cout << "eglif_mli::init_buffers_()" << std::endl;
#endif
  // spike input buffers
  ...
  // B_.__sys.function = eglif_mli_dynamics; // will be set just prior to the call to gsl_odeiv_evolve_apply()
...
void eglif_mli::recompute_internal_variables(bool exclude_timestep)
{
  const double __resolution = nest::Time::get_resolution().get_ms();  // do not remove, this is necessary for the resolution() function
...
extern "C" inline int eglif_mli_dynamics(double __time, const double ode_state[], double f[], void* pnode)
{
  typedef eglif_mli::State_ State_;
  // get access to node so we can almost work as in a member function
  assert( pnode );
  const eglif_mli& node = *( reinterpret_cast< eglif_mli* >( pnode ) );
...
void eglif_mli::update(nest::Time const & origin,const long from, const long to)
{
  const double __resolution = nest::Time::get_resolution().get_ms();  // do not remove, this is necessary for the resolution() function
...
const double g3__X__rec3__d__tmp_ = V_.__P__g3__X__rec3__d__g3__X__rec3 * S_.ode_state[State_::g3__X__rec3] + V_.__P__g3__X__rec3__d__g3__X__rec3__d * S_.ode_state[State_::g3__X__rec3__d];
    ...
    **/
    ...
    {  
        ...
        double __t = 0;
        B_.__sys.function = eglif_mli_dynamics;
...
void eglif_mli::handle(nest::DataLoggingRequest& e)
{
  B_.logger_.handle(e);
}


void eglif_mli::handle(nest::SpikeEvent &e)
{
  ...
  else if ( weight < 0.0 )
  {
    ...
    if ( nestml_buffer_idx == eglif_mli::PORT_NOT_AVAILABLE )
    {
      nestml_buffer_idx = std::get<0>(rport_to_nestml_buffer_idx[e.get_rport()]);
    }
    weight = -weight;
...
void eglif_mli::handle(nest::CurrentEvent& e)
{
  assert(e.get_delay_steps() > 0);
