...
nest.Connect(PC, DCN, {"rule": "fixed_indegree", "indegree": 40, "multapses": False, "autapses": False},
             PCDCN_conn_param)
...
for i, DCNind in enumerate(DCN):
    ...
    nest.Connect(MF, [DCNind], {'rule': 'fixed_indegree', 'indegree': 12, "multapses": False, "autapses": False},
                 MFDCN_conn_param)
