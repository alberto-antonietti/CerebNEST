...
#ifndef STDP_SYNAPSE_ALPHA_H
#define STDP_SYNAPSE_ALPHA_H
...
void register_stdp_synapse_alpha( const std::string& name );

template < typename targetidentifierT >
class stdp_synapse_alpha : public Connection< targetidentifierT >
{
...
public:
   ...
   */
  stdp_synapse_alpha( const stdp_synapse_alpha& ) = default;
  stdp_synapse_alpha& operator=( const stdp_synapse_alpha& ) = default;
...
template < typename targetidentifierT >
constexpr ConnectionModelProperties stdp_synapse_alpha< targetidentifierT >::properties;
...
template < typename targetidentifierT >
inline bool
stdp_synapse_alpha< targetidentifierT >::send( Event& e, size_t t, const CommonSynapseProperties& )
{
...
template < typename targetidentifierT >
void
stdp_synapse_alpha< targetidentifierT >::get_status( DictionaryDatum& d ) const
{
...
template < typename targetidentifierT >
void
stdp_synapse_alpha< targetidentifierT >::set_status( const DictionaryDatum& d, ConnectorModel& cm )
{
...
#endif // of #ifndef STDP_SYNAPSE_ALPHA_H
