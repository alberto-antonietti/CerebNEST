...
/*
 * There are three scenarios, in which AlbertoModule can be loaded by NEST:
 *
...
mynest::AlbertoModule albertomodule_LTX_mod;
#endif
// -- DynModule functions ------------------------------------------------------

mynest::AlbertoModule::AlbertoModule()
{
#ifdef LINKED_MODULE
...
const std::string
mynest::AlbertoModule::name( void ) const
{
  return std::string( "Alberto Module" ); // Return name of the module
}

const std::string
mynest::AlbertoModule::commandstring( void ) const
{
  // Instruct the interpreter to load albertomodule-init.sli
  return std::string( "(albertomodule-init) run" );
}

//-------------------------------------------------------------------------------------

void
mynest::AlbertoModule::init( SLIInterpreter* i )
{
