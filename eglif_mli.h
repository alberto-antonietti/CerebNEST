...
namespace nest
{
   void register_eglif_mli( const std::string& name );
}
...
class eglif_mli : public nest::ExtendedPostHistoryArchivingNode
{
public:
  /**
...
static std::vector< std::tuple< int, int > > rport_to_nestml_buffer_idx;
  ...
  **/
  ...
  friend class nest::RecordablesMap<eglif_mli>;
  friend class nest::UniversalDataLogger<eglif_mli>;
...
double complex_flag;
  ...
  **/
  ...
  {
    Buffers_(eglif_mli &);
    Buffers_(const Buffers_ &, eglif_mli &);

    /**
     * Logger for all analog data
    **/
    nest::UniversalDataLogger<eglif_mli> logger_;
...
inline nest::RingBuffer& get_I_stim() {
  ...
  static nest::RecordablesMap<eglif_mli> recordablesMap_;
  friend int eglif_mli_dynamics( double, const double ode_state[], double f[], void* pnode );
...
inline nest_port_t eglif_mli::send_test_event(nest::Node& target, nest_rport_t receptor_type, nest::synindex, bool)
{
...
inline nest_port_t eglif_mli::handles_test_event(nest::SpikeEvent&, nest_port_t receptor_type)
{
...
inline nest_port_t eglif_mli::handles_test_event(nest::CurrentEvent&, nest_port_t receptor_type)
{
  // You should usually not change the code in this function.
...
inline nest_port_t eglif_mli::handles_test_event(nest::DataLoggingRequest& dlr, nest_port_t receptor_type)
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
