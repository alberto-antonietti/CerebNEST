...
//   Recordables map
// ---------------------------------------------------------------------------
nest::RecordablesMap<eglif_pc_nestml> eglif_pc_nestml::recordablesMap_;

void
nest::register_eglif_pc_nestml( const std::string& name )
{
  register_node_model< eglif_pc_nestml >( name );
}
...
template <> 
void 
RecordablesMap<eglif_pc_nestml>::create()
  {
    // add state variables to recordables map
   insert_(eglif_pc_nestml_names::_V_m, &eglif_pc_nestml::get_V_m);
   insert_(eglif_pc_nestml_names::_I_adap, &eglif_pc_nestml::get_I_adap);
   insert_(eglif_pc_nestml_names::_I_dep, &eglif_pc_nestml::get_I_dep);
   ...
   insert_(eglif_pc_nestml_names::_g4__X__rec4, &eglif_pc_nestml::get_g4__X__rec4);
   insert_(eglif_pc_nestml_names::_g4__X__rec4__d, &eglif_pc_nestml::get_g4__X__rec4__d);
   insert_(eglif_pc_nestml_names::_g2__X__rec2, &eglif_pc_nestml::get_g2__X__rec2);
   insert_(eglif_pc_nestml_names::_g2__X__rec2__d, &eglif_pc_nestml::get_g2__X__rec2__d);
   insert_(eglif_pc_nestml_names::_g3__X__rec3, &eglif_pc_nestml::get_g3__X__rec3);
   insert_(eglif_pc_nestml_names::_g3__X__rec3__d, &eglif_pc_nestml::get_g3__X__rec3__d);
    // add recordable inline expressions to recordables map
	insert_(eglif_pc_nestml_names::_I_syn, &eglif_pc_nestml::get_I_syn);
	insert_(eglif_pc_nestml_names::_I_tot, &eglif_pc_nestml::get_I_tot);

    // Add vector variables  
  }
}
std::vector< std::tuple< int, int > > eglif_pc_nestml::rport_to_nestml_buffer_idx =
{
  { eglif_pc_nestml::REC1, eglif_pc_nestml::PORT_NOT_AVAILABLE },
  { eglif_pc_nestml::REC2, eglif_pc_nestml::PORT_NOT_AVAILABLE },
  { eglif_pc_nestml::REC3, eglif_pc_nestml::PORT_NOT_AVAILABLE },
  { eglif_pc_nestml::REC4, eglif_pc_nestml::PORT_NOT_AVAILABLE },
  { eglif_pc_nestml::CF_SPIKES, eglif_pc_nestml::PORT_NOT_AVAILABLE },
};
...
eglif_pc_nestml::Parameters_::Parameters_()
{
}

eglif_pc_nestml::State_::State_()
{
}
...
eglif_pc_nestml::Buffers_::Buffers_(eglif_pc_nestml &n):
  logger_(n)
...
eglif_pc_nestml::Buffers_::Buffers_(const Buffers_ &, eglif_pc_nestml &n):
  logger_(n)
  , spike_inputs_( std::vector< nest::RingBuffer >( NUM_SPIKE_RECEPTORS ) )
  , spike_inputs_grid_sum_( std::vector< double >( NUM_SPIKE_RECEPTORS ) )
  , spike_input_received_( std::vector< nest::RingBuffer >( NUM_SPIKE_RECEPTORS ) )
...
eglif_pc_nestml::eglif_pc_nestml():ExtendedPostHistoryArchivingNode(), P_(), S_(), B_(*this)
{
...
eglif_pc_nestml::eglif_pc_nestml(const eglif_pc_nestml& __n):
...
eglif_pc_nestml::~eglif_pc_nestml()
{
...
void eglif_pc_nestml::init_state_internal_()
{
#ifdef DEBUG
...
void eglif_pc_nestml::init_buffers_()
{
#ifdef DEBUG
...
void eglif_pc_nestml::recompute_internal_variables(bool exclude_timestep)
{
  const double __resolution = nest::Time::get_resolution().get_ms();  // do not remove, this is necessary for the resolution() function
...
void eglif_pc_nestml::pre_run_hook()
{
  B_.logger_.init();
...
extern "C" inline int eglif_pc_nestml_dynamics(double __time, const double ode_state[], double f[], void* pnode)
{
  typedef eglif_pc_nestml::State_ State_;
  // get access to node so we can almost work as in a member function
  assert( pnode );
  const eglif_pc_nestml& node = *( reinterpret_cast< eglif_pc_nestml* >( pnode ) );
...
void eglif_pc_nestml::update(nest::Time const & origin,const long from, const long to)
{
  const double __resolution = nest::Time::get_resolution().get_ms();  // do not remove, this is necessary for the resolution() function
...
const double g3__X__rec3__d__tmp_ = V_.__P__g3__X__rec3__d__g3__X__rec3 * S_.ode_state[State_::g3__X__rec3] + V_.__P__g3__X__rec3__d__g3__X__rec3__d * S_.ode_state[State_::g3__X__rec3__d];
    ...
    **/
    ...
    {  
        ...
        double __t = 0;
        B_.__sys.function = eglif_pc_nestml_dynamics;
...
void eglif_pc_nestml::handle(nest::DataLoggingRequest& e)
{
  B_.logger_.handle(e);
}


void eglif_pc_nestml::handle(nest::SpikeEvent &e)
{
